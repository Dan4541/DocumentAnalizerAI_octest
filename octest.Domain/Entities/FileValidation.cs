...
public class FileValidation
{
    ...
    public static FileValidation Create(Guid fileUploadId,
        int rowNumber, string columnName, string errorMessage,
        ValidationSeverity severity, string? invalidValue = null)
    {
